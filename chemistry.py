...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    total_atomic_mass = 0
    keys = list(periodic_table_dict.keys())
    values = list(periodic_table_dict.values())
    
    for element_list in symbol_quantity_list:
        number_of_atoms = element_list[1]
        symbol = element_list[0]
        single_atom_mass = periodic_table_dict[symbol][1]
        mass_of_all_of_1_element = number_of_atoms * single_atom_mass
        total_atomic_mass += mass_of_all_of_1_element
...
def main():
    ...
    beans = parse_formula(molecule, periodic_table)
    burrito = compute_molar_mass(beans, periodic_table)
    print(f'{burrito:.5f} grams/mole')
    moles = mass / burrito
